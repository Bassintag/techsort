...
** Last update Tue Nov 15 23:34:01 2016 Antoine Stempfer
*/
...
void	instruct_sal(t_env *, t_instruct_tkn);
void	instruct_sbl(t_env *, t_instruct_tkn);
...
void	instruct_dbg(t_env *, t_instruct_tkn);
